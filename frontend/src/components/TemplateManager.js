...
const TemplateManager = () => {
  ...
  const updateMarker = (index, field, value) => {
    const updatedData = { ...templateData };
    updatedData.template_data.identification.markers[index][field] = field === "required" ? value : value;
    setTemplateData(updatedData);
  };
  ...
  const updateField = (index, field, value) => {
    ...
    if (field.includes(".")) {
      ...
      updatedData.template_data.fields[index][parent][child] = value;
    } else {
      updatedData.template_data.fields[index][field] = value;
    }
  ...
  // Test a template
  const handleTestTemplate = async (templateId) => {
    setTestResults(null);
    setSelectedInvoice("");
    setShowTestModal(true);
    setCurrentTemplate(templates.find(t => t.template_id === templateId));
  };
  ...
  const runTemplateTest = async () => {
    ...
    try {
      ...
      const results = await testTemplate(currentTemplate.template_id, selectedInvoice);
