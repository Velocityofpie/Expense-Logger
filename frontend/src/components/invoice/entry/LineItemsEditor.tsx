// src/components/invoice/entry/LineItemsEditor.tsx
  ...
  return (
    <div>
      ...
      {items.length > 0 ? (
                ...
                <tr key={index}>
                  <td className="px-4 py-3 whitespace-nowrap">
                    <input
                      ...
                      className="w-full px-2 py-1 text-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white rounded-md focus:ring-primary-500 focus:border-primary-500"
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="relative rounded-md">
                      ...
                      <input
                        ...
                        className="w-full pl-6 pr-2 py-1 text-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white rounded-md focus:ring-primary-500 focus:border-primary-500"
                      />
                    </div>
                  </td>
            ...
            {items.length > 0 && (
              <tfoot className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  ...
                  <td className="px-4 py-3 text-left text-sm font-medium text-gray-900 dark:text-gray-100">
        ...
        <div className="py-8 text-center border border-dashed rounded-md bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-400">No line items yet. Click "Add Item" to add products to this invoice.</p>
        </div>
      )}
    </div>
  );
